...
$("#btnAceptarModal").click(function() {
    ...
    if($("#nombre").val() == ""){
        ...
        if(accion == "ACTUALIZAR"){
            url = "http://localhost:8081/colores/actualizar";
        } else {
            url = "http://localhost:8081/colores/nuevo";
        }
...
$("body").on("click", ".editar", function() {
    ...
    $.ajax({
        url: "http://localhost:8081/colores/colorXId?id=" + id,
        dataType: 'html',
        data: null,
        type: 'GET',
        async: false,
...
$("body").on("click", ".deshabilitar", function() {
        ...
        $.ajax({
            url: "http://localhost:8081/colores/deshabilitar",
            dataType: 'html',
            data: data,
            type: 'POST',
            async: false,
...
$("body").on("click", ".habilitar", function() {
        ...
        $.ajax({
            url: "http://localhost:8081/colores/habilitar",
            dataType: 'html',
            data: data,
            type: 'POST',
            async: false,
